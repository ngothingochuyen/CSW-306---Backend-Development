<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Profile.aspx.cs" Inherits="ProjectBackendFoodie.User.Profile" %>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                                    ...
                                    <div class="userData ml-3">
                                        ...
                                        <h6 class="d-block">
                                            <a href="javascript:void(0);">
                                                <asp:Label ID="lblUsername" runat="server" Tooltrip="Unique Username">
                                        ...
                                        <h6 class="d-block">
                                            <a href="javascript:void(0);">
                                                <asp:Label ID="lblEmail" runat="server" Tooltrip="User Email">
                                        ...
                                        <h6 class="d-block">
                                            <a href="javascript:void(0);">
                                                <asp:Label ID="lblCreatedDate" runat="server" Tooltrip="Account Created On">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <ul class="nav nav-tasb mb-4" id="myTab" role="tablist">
                                        <li class="nav-item">
                                    ...
                                    <div class="tab-content ml-1" id="myTabContent">
                                        ...
                                        <div class="tab-pane fade show active" id="basicInfo" role="tab-panel" aria-labelledby="basicInfo-tab">
